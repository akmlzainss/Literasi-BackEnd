    ...
    <div class="main-card">
        <div class="card-header-custom">
            ...
            <div class="d-flex align-items-center gap-2 text-white">
                ...
                <span>Total: {{ $artikels->total() + $kategoris->total() + $siswas->total() + $penghargaan->total() }} data</span>
            </div>
        </div>
                                ...
                                <tbody>
                                    @forelse ($artikels as $index => $artikel)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="student-email">{{ $artikel->deleted_at->format('d M Y H:i') }}</div>
                                            </td>
                                            <td>
                                                <div class="action-buttons-table">
                                                    <form action="{{ route('admin.pengaturan.restore', ['model' => 'artikel', 'id' => $artikel->id]) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        <button type="submit" class="btn-action-table btn-view-table" title="Restore Artikel">
                                                    ...
                                                    <form action="{{ route('admin.pengaturan.forceDelete', ['model' => 'artikel', 'id' => $artikel->id]) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus artikel ini secara permanen?')">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn-action-table btn-delete-table" title="Hapus Permanen">
                                ...
                                <tbody>
                                    @forelse ($kategoris as $index => $kategori)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="student-email">{{ $kategori->deleted_at->format('d M Y H:i') }}</div>
                                            </td>
                                            <td>
                                                <div class="action-buttons-table">
                                                    <form action="{{ route('admin.pengaturan.restore', ['model' => 'kategori', 'id' => $kategori->id]) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        <button type="submit" class="btn-action-table btn-view-table" title="Restore Kategori">
                                                            <i class="fas fa-undo"></i>
                                                        </button>
                                                    </form>
                                ...
                                <tbody>
                                    @forelse ($siswas as $index => $siswa)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="student-email">{{ $siswa->deleted_at->format('d M Y H:i') }}</div>
                                            </td>
                                            <td>
                                                <div class="action-buttons-table">
                                                    <form action="{{ route('admin.pengaturan.restore', ['model' => 'siswa', 'id' => $siswa->id]) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        <button type="submit" class="btn-action-table btn-view-table" title="Restore Siswa">
                                                            <i class="fas fa-undo"></i>
                                                        </button>
                                                    </form>
                                ...
                                <tbody>
                                    @forelse ($penghargaan as $index => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="student-name">{{ Str::limit($item->artikel->judul ?? 'N/A', 40) }}</div>
                                            </td>
                                            <td>
                                                <span class="class-badge">{{ $item->bulan_tahun }}</span>
                                            </td>
                                            <td>
                                                <div class="student-email">{{ $item->deleted_at->format('d M Y H:i') }}</div>
                                            </td>
                                            <td>
                                                <div class="action-buttons-table">
                                                    <form action="{{ route('admin.pengaturan.restore', ['model' => 'penghargaan', 'id' => $item->id]) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        <button type="submit" class="btn-action-table btn-view-table" title="Restore Penghargaan">
                                                            <i class="fas fa-undo"></i>
                                                        </button>
                                                    </form>
