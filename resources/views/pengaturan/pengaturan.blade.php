        ...
        <div class="accordion" id="alurSistemAccordion">
            <div class="accordion-item border-0 shadow-sm">
                <h2 class="accordion-header" id="headingArtikel">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseArtikel" aria-expanded="true" aria-controls="collapseArtikel">
                        <i class="bi bi-file-earmark-text me-2"></i> Modul Artikel
                    </button>
                </h2>
                <div id="collapseArtikel" class="accordion-collapse collapse show" aria-labelledby="headingArtikel" data-bs-parent="#alurSistemAccordion">
            ...
            <div class="accordion-item border-0 shadow-sm">
                <h2 class="accordion-header" id="headingSiswa">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSiswa" aria-expanded="false" aria-controls="collapseSiswa">
                        <i class="bi bi-people me-2"></i> Modul Siswa
                    </button>
                </h2>
                <div id="collapseSiswa" class="accordion-collapse collapse" aria-labelledby="headingSiswa" data-bs-parent="#alurSistemAccordion">
                    <div class="accordion-body">
                        <ol class="mb-0">
            ...
            <div class="accordion-item border-0 shadow-sm">
                <h2 class="accordion-header" id="headingPenghargaan">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePenghargaan" aria-expanded="false" aria-controls="collapsePenghargaan">
                        <i class="bi bi-award me-2"></i> Modul Penghargaan
                    </button>
                </h2>
                <div id="collapsePenghargaan" class="accordion-collapse collapse" aria-labelledby="headingPenghargaan" data-bs-parent="#alurSistemAccordion">
                    <div class="accordion-body">
                        <ol class="mb-0">
                            ...
                            <li>Dapat melakukan <strong>Edit</strong> atau <strong>Hapus</strong> penghargaan jika diperlukan.</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item border-0 shadow-sm">
                ...
                <div id="collapseLaporan" class="accordion-collapse collapse" aria-labelledby="headingLaporan" data-bs-parent="#alurSistemAccordion">
                    <div class="accordion-body">
                        <ol class="mb-0">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="current_password" class="form-label">
                                <i class="fas fa-lock me-2"></i> Password Saat Ini <span class="text-muted">(opsional)</span>
                            </label>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (newPasswordInput) {
                newPasswordInput.addEventListener('input', function() {
                    ...
                    strengthBar.className = `strength-progress ${strength <= 1 ? 'weak' : strength <= 2 ? 'medium' : strength <= 3 ? 'good' : 'strong'}`;
            ...
            if (profilePhotoInput) {
                profilePhotoInput.addEventListener('change', (event) => {
                    ...
                    if (file) {
                        ...
                        reader.onload = (e) => document.querySelector('.profile-preview').src = e.target.result;
