...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <!-- Kelola Menu with Submenu -->
            <div
                class="nav-item nav-dropdown {{ Request::routeIs('admin.artikel.*') || Request::routeIs('admin.video.*') || Request::routeIs('admin.penghargaan.*') || Request::routeIs('admin.siswa.*') || Request::routeIs('admin.kategori.*') ? 'open' : '' }}">
                ...
                <div class="nav-submenu">
                    ...
                    <a href="{{ route('admin.penghargaan.index') }}"
                        class="nav-link {{ Request::routeIs('admin.penghargaan.*') ? 'active' : '' }}">
