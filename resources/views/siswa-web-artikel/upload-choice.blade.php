...
<div class="container py-5">
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-6 col-lg-5">
            <div class="choice-card choice-card-disabled animate-ready">
                <div class="card-body text-center">
                    <div class="choice-icon mb-4">
                        <i class="fas fa-video fa-4x text-secondary"></i>
                        <div class="icon-glow disabled"></div>
                    </div>
                    <h4 class="card-title fw-bold mb-3">Upload Video</h4>
                    <p class="card-text text-muted mb-4">
                        Punya karya dalam bentuk video? Upload di sini! 
                        Fitur ini akan segera hadir untuk memperkaya konten SIPENA.
                    </p>
                    <div class="choice-features mb-4">
                        <div class="feature-item">
                    ...
                    <div class="coming-soon-badge">
                        <span class="badge bg-warning text-dark">
                            <i class="fas fa-star me-1"></i>Coming Soon
                        </span>
                    </div>
                </div>
            </div>
