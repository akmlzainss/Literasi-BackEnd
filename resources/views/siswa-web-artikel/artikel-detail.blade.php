                ...
                .then(data => {
                    if (data.success) {
                        ...
                        if (data.new_comment_html) {
                            ...
                            const parentComment = document.querySelector(`.komentar-item[data-id="${parentId}"]`);
                            
                            if (parentComment) {
                                let repliesContainer = parentComment.querySelector('.komentar-replies');
                                if (!repliesContainer) {
                                    repliesContainer = document.createElement('div');
                                    repliesContainer.className = 'komentar-replies';
                                    repliesContainer.style.cssText = 'margin-left: 50px; margin-top: 1rem; border-left: 2px solid #e9ecef; padding-left: 15px;';
