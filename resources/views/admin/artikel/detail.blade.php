                    ...
                    <div class="profile-body">
                        <div class="info-item">
                            ...
                            <div class="info-content">
                                ...
                                <span class="info-value">{{ $siswa->email }}</span>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-content">
                                ...
                                <span class="info-value">{{ $siswa->updated_at->diffForHumans() }}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-4 mb-3">
                        <div class="stat-card stat-primary">
                            ...
                            <div class="stat-content">
                                <h3 class="stat-number">{{ $siswa->artikel()->count() }}</h3>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="stat-card stat-success">
                            ...
                            <div class="stat-content">
                                <h3 class="stat-number">{{ $siswa->artikel()->where('status', 'disetujui')->count() }}</h3>
                        ...
                        <div class="stat-card stat-warning">
                            ...
                            <div class="stat-content">
                                <h3 class="stat-number">
                                    {{ number_format($siswa->artikel()->avg('nilai_rata_rata') ?? 0, 1) }}
                                </h3>
