                ...
                <div class="main-card">
                    ...
                    <div class="card-body-custom">
                        ...
                        <form action="{{ route('admin.artikel.store') }}" method="POST" enctype="multipart/form-data"
                            id="create-artikel-form" novalidate>
                            @csrf
                            <!-- Judul Artikel -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="penulis_type" id="penulis_admin"
                                        value="admin" {{ old('penulis_type', 'admin') == 'admin' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="penulis_type" id="penulis_siswa"
                                        value="siswa" {{ old('penulis_type') == 'siswa' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            <label for="id_siswa" class="form-label">
                                                <i class="fas fa-search me-2"></i>Cari Nama Siswa <span
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenis" id="jenis" class="form-select" required>
                                    <option value="bebas" {{ old('jenis') == 'bebas' ? 'selected' : '' }}>
                                        Bebas
                                    </option>
                                    <option value="resensi_buku" {{ old('jenis') == 'resensi_buku' ? 'selected' : '' }}>
                                        Resensi Buku
                                    </option>
                                    <option value="resensi_film" {{ old('jenis') == 'resensi_film' ? 'selected' : '' }}>
                                        Resensi Film
                                    </option>
                                    <option value="video" {{ old('jenis') == 'video' ? 'selected' : '' }}>
                                        Video
                                    </option>
                                </select>
                                @error('jenis')
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-select" required>
                                    ...
                                    <option value="draf" {{ old('status') == 'draf' ? 'selected' : '' }}>
                                        Draf
                                    </option>
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.responseJSON?.errors) {
                            $.each(xhr.responseJSON.errors, function(key, errors) {
                                const errorHtml =
                                    `<div class="alert alert-danger mt-2">${errors[0]}</div>`;
