        ...
        <div class="action-buttons">
            ...
            @if (Auth::guard('admin')->check())
                ...
                <form action="{{ route('admin.artikel.destroy', $artikel->id) }}" method="POST" style="display:inline;"
                    ...
                    @csrf
                    @method('DELETE')
                    <button type="button" class="btn btn-danger-custom no-loading"
    ...
    <div class="main-card detail-card full-width">
        ...
        <div class="card-body-custom">
            ...
            <div class="article-comments mt-5">
                <h5><i class="fas fa-comments me-2" style="color: var(--primary-blue);"></i>Komentar
                    ({{ $artikel->komentarArtikel->where('id_komentar_parent', null)->count() }})</h5>
                @php
                ...
                @if (Auth::guard('admin')->check() || Auth::guard('siswa')->check())
                    <div class="comment-form mt-4">
                        <h5><i class="fas fa-plus-circle me-2" style="color: var(--primary-blue);"></i>Tambahkan Komentar
                        </h5>
                        <form
