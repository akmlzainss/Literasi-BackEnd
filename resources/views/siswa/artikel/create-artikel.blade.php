                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4">
                        <div class="p-3 border rounded-3 bg-light sticky-top" style="top: 100px;">
                            ...
                            <div class="mb-3">
                                <label for="usulan_kategori" class="form-label fw-semibold">Atau Usulkan Kategori
                                    Baru</label>
                                <input type="text" name="usulan_kategori" id="usulan_kategori" class="form-control"
                                    placeholder="Contoh: Teknologi" value="{{ old('usulan_kategori') }}">
                                <small class="form-text text-muted">Isi salah satu: pilih kategori atau usulkan
                                    baru.</small>
                            </div>
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body">
                    <p class="mb-0 fs-5">
                        ...
                        <br><br>
                        <small class="text-muted">Setelah dikirim, artikel tidak dapat diedit sampai proses review
                            selesai.</small>
                    </p>
                </div>
