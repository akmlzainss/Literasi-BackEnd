...
<head>
    ...
    <title>Kelola Artikel - SMKN 11 Bandung</title>
    ...
    <div class="main-content">
        ...
        <div class="topbar">
            <div class="topbar-left">
                <h6 class="mb-0 fw-bold text-primary">Kelola Artikel Literasi Akhlak</h6>
            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="article-card">
                                    ...
                                    <div class="article-content">
                                        ...
                                        <p class="article-excerpt-card">Membahas bagaimana literasi digital menjadi keterampilan penting bagi generasi muda dalam menghadai tantangan teknologi modern dan cara mengimplementasikannya...</p>
