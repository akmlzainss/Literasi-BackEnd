...
class AdminAuthController extends Controller
{
    ...
    /**
     * LOGIN KHUSUS ADMIN: Hanya mencoba login sebagai admin.
     */
    public function adminLogin(Request $request)
    {
        ...
        // Hanya coba login sebagai Admin
        ...
        return back()->with('error', 'Email atau Password admin yang Anda masukkan salah.')->withInput($request->only('email', 'remember'));
    }
