...
class PengaturanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pengaturan.pengaturan', compact('admin', 'perangkat', 'ipAddress', 'isOnline'));
    }
    ...
    public function keamanan()
    {
        ...
        return view('admin.pengaturan.keamanan', compact('admin', 'perangkat', 'ipAddress'));
    }
    ...
    public function trash()
    {
        ...
        return view('admin.pengaturan.trash', compact('artikels', 'kategoris', 'siswas', 'penghargaan'));
    }
